...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userprofile_userprofile', (
            ...
            ('state', self.gf('localflavor.us.models.USStateField')(default='OR', max_length=2, blank=True)),
            ('phone_number', self.gf('localflavor.us.models.PhoneNumberField')(max_length=20, blank=True)),
