...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cause.manager'
        db.add_column(u'cause_cause', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userprofile.UserProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cause.manager'
        db.delete_column(u'cause_cause', 'manager_id')
